    ...
    <div className="app-container">
      ...
      <div className="footer">
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
          {t('footer.poweredBy')}
          <a href="https://github.com/0zBoogeyman/option-scanner" target="_blank" rel="noopener noreferrer" aria-label="GitHub" style={{ display: 'inline-flex', alignItems: 'center', color: 'var(--primary-color)' }}>
